...
const fetchHoodies = async () => {
  ...
  try {
    ...
    console.error('Failed to fetch hoodies:', e);
  } finally {
    isLoading.value = false;
  }
};

watch(searchTerm, () => { clearTimeout(debounceTimer); debounceTimer = setTimeout(fetchHoodies, 300); });
  ...
  <div class="shop-page">
    ...
    <div class="filter-bar">
      <div class="search-wrap">
        ...
        <input type="text" v-model="searchTerm" placeholder="Search hoodies..." class="search-input" />
      </div>
    ...
    <div v-else>
      ...
      <div v-if="hoodies.length === 0" class="empty-state">
